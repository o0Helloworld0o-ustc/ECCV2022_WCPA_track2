...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--update_html_freq', type=int, default=256, help='frequency of saving training results to html')
        ...
        parser.add_argument('--save_latest_freq', type=int, default=40960, help='frequency of saving the latest results')
